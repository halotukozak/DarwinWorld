...
class AbstractMapTest : FunSpec({
  ...
  test("removeDeadAnimals") {
    ...
    map.elements[Vector(0, 0)]!!.add(Animal(0, Genome.random(config.genomeLength), Direction.random()))
    map.elements[Vector(0, 0)]!!.add(Animal(1, Genome.random(config.genomeLength), Direction.random()))
    map.elements[Vector(0, 0)]!!.add(Animal(0, Genome.random(config.genomeLength), Direction.random()))

    map.removeDeadAnimals()

    map.elements[Vector(0, 0)]!!.size shouldBe 1
    (map.elements[Vector(0, 0)]!!.first() as Animal).energy shouldBe 1
  }
  ...
  test("rotateAnimals") {
    ...
    map.elements[Vector(0, 0)]!!.add(animal1)
    map.elements[Vector(0, 0)]!!.add(animal2)
    map.elements[Vector(1, 1)]!!.add(animal3)
  ...
  test("moveAnimals") {
    ...
    animals1.forEach { map.elements[Vector(0, 0)]!!.add(it) }
    val animals2 = (0..7).map { Animal(100, Genome.random(config.genomeLength), Direction.entries[it]) }
    animals2.forEach { map.elements[Vector(99, 29)]!!.add(it) }

    map.moveAnimals()

    map.elements[Vector(0, 0)]!!.size shouldBe 1
    map.elements[Vector(0, 0)]!! shouldContain animals1[0] // N
    animals1[0].direction shouldBe S
    map.elements[Vector(1, 0)]!! shouldContain animals1[1] // NE
    animals1[1].direction shouldBe SW
    map.elements[Vector(1, 0)]!! shouldContain animals1[2] // E
    animals1[2].direction shouldBe E
    map.elements[Vector(1, 1)]!! shouldContain animals1[3] // SE
    animals1[3].direction shouldBe SE
    map.elements[Vector(0, 1)]!! shouldContain animals1[4] // S
    animals1[4].direction shouldBe S
    map.elements[Vector(99, 1)]!! shouldContain animals1[5] // SW
    animals1[5].direction shouldBe SW
    map.elements[Vector(99, 0)]!! shouldContain animals1[6] // W
    animals1[6].direction shouldBe W
    map.elements[Vector(99, 0)]!! shouldContain animals1[7] // NW
    animals1[7].direction shouldBe SE

    map.elements[Vector(99, 29)]!!.size shouldBe 1
    map.elements[Vector(99, 28)]!! shouldContain animals2[0] // N
    animals2[0].direction shouldBe N
    map.elements[Vector(0, 28)]!! shouldContain animals2[1] // NE
    animals2[1].direction shouldBe NE
    map.elements[Vector(0, 29)]!! shouldContain animals2[2] // E
    animals2[2].direction shouldBe E
    map.elements[Vector(0, 29)]!! shouldContain animals2[3] // SE
    animals2[3].direction shouldBe NW
    map.elements[Vector(99, 29)]!! shouldContain animals2[4] // S
    animals2[4].direction shouldBe N
    map.elements[Vector(98, 29)]!! shouldContain animals2[5] // SW
    animals2[5].direction shouldBe NE
    map.elements[Vector(98, 29)]!! shouldContain animals2[6] // W
    animals2[6].direction shouldBe W
    map.elements[Vector(98, 28)]!! shouldContain animals2[7] // NW
  ...
  test("consumePlants") {
    ...
    map.elements[Vector(0, 0)]!!.add(animal1)
    map.elements[Vector(0, 0)]!!.add(animal2)
    map.elements[Vector(0, 0)]!!.add(animal3)
    map.elements[Vector(0, 0)]!!.add(Plant)
    map.elements[Vector(1, 1)]!!.add(Plant)
    ...
    map.elements[Vector(0, 0)]!! shouldNotContain Plant
    map.elements[Vector(1, 1)]!! shouldContain Plant
  }
  ...
  test("breedAnimals") {
    ...
    map.elements[Vector(0, 0)]!!.add(animal2)
    map.elements[Vector(0, 0)]!!.add(animal3)
    map.elements[Vector(1, 1)]!!.add(animal4)
    map.elements[Vector(1, 1)]!!.add(animal5)
    map.breedAnimals()
    map.elements[Vector(0, 0)]!!.size shouldBe 4
    ...
    animal3.energy shouldBe 20
    map.elements[Vector(1, 1)]!!.size shouldBe 2
  }
})
